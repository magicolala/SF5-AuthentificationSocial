 ...
 */
final class Version20201026171557 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        , password VARCHAR(255) NOT NULL COLLATE BINARY, github_id VARCHAR(255) DEFAULT NULL COLLATE BINARY, email VARCHAR(180) DEFAULT NULL)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        , password VARCHAR(255) NOT NULL, github_id VARCHAR(255) DEFAULT NULL, email VARCHAR(180) NOT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO user (id, email, roles, password, github_id) SELECT id, email, roles, password, github_id FROM __temp__user');
        $this->addSql('DROP TABLE __temp__user');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_8D93D649E7927C74 ON user (email)');
    }
